...
int main()
{
	...
	while(1)
	{
		if(write(user_led, "0", 1) == -1)	// extinction de la LED user
		...
		if(write(sys_led, "0", 1) == -1)	// extinction de la LED système
			perror("Erreur d'ecriture");
