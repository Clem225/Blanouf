...
\begin{figure}[h]
	\centering
		\includegraphics[width=0.4\textwidth]{screenstp6/42(sansstress).png}
		\caption{Résultat sans stress}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[width=1\textwidth]{screenstp6/42(avecstress).png}
		\caption{Résultat avec stress}
\end{figure}
\end{itemize}
