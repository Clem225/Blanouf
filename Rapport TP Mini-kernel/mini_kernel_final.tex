...
\begin{figure}[!h]
	\centering
		\includegraphics[width=0.39\textwidth]{screens/prod_plus_rapide_sem_2prod_meme_vitesse_1conso.png}
		\caption{2 producteurs plus rapides que le consommateur}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width=0.38\textwidth]{screens/conso_plus_rapide_sem_2prod_meme_vitesse_1conso.png}
...
\begin{figure}[!h]
	\centering
		...
		\caption{2 consommateurs plus rapides que le producteur}
